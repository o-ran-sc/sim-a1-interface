...
RESULT=""
do_curl DELETE  /policytypes/ptype1/kafkadispatcher/alpha 200
...
echo "=== Put an a1 policy alpha to update ==="
RESULT=""
do_elapsetime_curl PUT  /policytypes/ptype1/kafkadispatcher/alpha 200 jsonfiles/alpha_policy.json 5
...
RESULT=""
do_curl PUT  /policytypes/ptype1/kafkadispatcher/beta 200 jsonfiles/beta_policy.json
...
RESULT="json:$res"
do_curl PUT  /policytypes/ptype1/kafkadispatcher/alpha 500 jsonfiles/alpha_policy.json
