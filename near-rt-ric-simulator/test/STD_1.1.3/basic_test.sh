...
RESULT="{\"scope\": {\"ueId\": \"ue1\", \"groupId\": \"group1\", \"sliceId\": \"slice1\", \"qosId\": \"qos1\", \"cellId\": \"cell1\"}, \"statement\": {\"priorityLevel\": 5}}"
do_curl PUT /A1-P/v1/policies/pi1 201 jsonfiles/pi1.json

echo "=== API: Update policy instance pi1 ==="
RESULT="{\"scope\": {\"ueId\": \"ue1\", \"groupId\": \"group1\", \"sliceId\": \"slice1\", \"qosId\": \"qos1\", \"cellId\": \"cell1\"}, \"statement\": {\"priorityLevel\": 6}}"
...
do_curl GET /A1-P/v1/policies 401

echo "=== API: Get policy status ==="
RESULT="{\"enforceStatus\": \"UNDEFINED\"}"
do_curl GET /A1-P/v1/policies/pi1/status 200

echo "=== API: Create policy instance pi2 ==="
RESULT="{\"scope\": {\"ueId\": \"ue2\", \"groupId\": \"group2\", \"sliceId\": \"slice2\", \"qosId\": \"qos2\", \"cellId\": \"cell2\"}, \"statement\": {\"priorityLevel\": 10}}"
...
RESULT="{\"type\": \"about:blank\", \"title\": \"The policy identity does not exist.\", \"status\": 404, \"detail\": \"There is no existing policy instance with the identity: pi1\", \"instance\": \"pi1\"}"
...
echo "=== API: Get policy status for pi2 ==="
RESULT="{\"enforceStatus\": \"NOTOK\", \"enforceReason\": \"notok_reason\"}"
do_curl GET /A1-P/v1/policies/pi2/status 200
